...
set	VIP_NAME=dbgRom_Pjt

cd /D %TARGET_OS_DIR%
copy /y Makefile.nb_lk Makefile
cd /D %TARGET_VIP_DIR%
del /s %VIP_NAME% /q
...
call vxprj component add INCLUDE_LOADER_HOOKS
...
call vxprj component add ORTHROS
call vxprj component remove INCLUDE_NET_BOOT_CONFIG
call vxprj component remove INCLUDE_NET_INIT
call vxprj component remove INCLUDE_WDB_BP_SYNC
call vxprj component remove INCLUDE_WDB_PRE_KERNEL_INIT
call vxprj build set %VIP_NAME%.wpj default
cd /D %TARGET_ENV_DIR%
