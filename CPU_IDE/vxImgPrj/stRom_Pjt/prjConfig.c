...
/*
GENERATED: Thu Apr 29 17:51:30 +1000 2021
...
#include <net/coreip/usrNetBootConfig.c>
...
void usrNetworkInit (void)
    ...
    usrCheckNetBootConfig (pDevName, uNum, pAddrString,                    netmask, sysBootParams.gad); /* network boot device configuration with boot parameters */
    usrNetUtilsInit ();                 /* Initialize network utility routines */
    }
