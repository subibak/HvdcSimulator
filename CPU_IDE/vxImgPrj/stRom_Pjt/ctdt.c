...
__asm("	.byte 0");
__asm("	.ascii \"set PRJ_FULL_PATH D:/HVDC_Simulator/CPU_IDE/vxImgPrj/stRom_Pjt\"");
__asm("	.byte 0");
...
static const char oscbOSBuildPath[] = "D:/HVDC_Simulator/CPU_IDE/vxImgPrj/stRom_Pjt";
