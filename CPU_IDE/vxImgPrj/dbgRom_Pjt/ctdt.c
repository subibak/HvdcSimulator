...
void _STI___11_wlocale_cpp_dfc18c9e();
...
void (*_ctors[])() =
    ...
    _STI___11_wlocale_cpp_dfc18c9e,
...
#endif
#endif
__asm("	.ascii \"set WIND_HOME D:/Tornado690\"");
__asm("	.byte 0");
__asm("	.ascii \"set WIND_BASE $(WIND_HOME)/vxworks-6.9\"");
__asm("	.byte 0");
__asm("	.ascii \"set PRJ_FULL_PATH D:/HVDC_Simulator/CPU_IDE/vxImgPrj/dbgRom_Pjt\"");
__asm("	.byte 0");
__asm("	.ascii \"set VSB_DIR $(WIND_BASE)/target/lib\"");
__asm("	.byte 0");
__asm("	.ascii \"set BSP_DIR $(WIND_BASE)/target/config/lk11_lkv_120\"");
__asm("	.byte 0");
__asm("	.ascii \"set ANALYSIS_DKM_DIR $(VSB_DIR)/ppc/PPC32/e500v2common/dkm/analysis\"");
__asm("	.byte 0");
...
static const char oscbOSBuildPath[] = "D:/HVDC_Simulator/CPU_IDE/vxImgPrj/dbgRom_Pjt";
